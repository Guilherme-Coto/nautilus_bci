...
def generate_music_tracks(sound_dir, selected_subfolder='real'):
    ...
    music_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "music_tracks"))
    config_file = os.path.abspath(os.path.join(os.path.dirname(__file__), "music_offset_config.json"))
...
class MusicMemoryTaskApp(QMainWindow):
    ...
    def __init__(self):
        ...
        self.sound_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "music_tracks"))
