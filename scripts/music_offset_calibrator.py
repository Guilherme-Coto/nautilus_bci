...
class MusicOffsetCalibratorApp(QMainWindow):
    ...
    def __init__(self):
        ...
        self.music_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "music_tracks"))
        self.config_file = os.path.abspath(os.path.join(os.path.dirname(__file__), "music_offset_config.json"))
    ...
    def init_ui(self):
        ...
        from music_memory_task import discover_music_subfolders
